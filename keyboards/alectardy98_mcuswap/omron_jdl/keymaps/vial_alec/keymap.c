...
bool led_update_user(led_t led_state) {
    if (IS_LAYER_ON(_FN) || led_state.scroll_lock) {
        writePinLow(GP29);  // ON (active-low)
    } else {
        writePinHigh(GP29); // OFF
    }

    if (IS_LAYER_ON(_NUM) || led_state.num_lock) {
        writePinLow(GP28);  // ON (active-low)
    } else {
        writePinHigh(GP28); // OFF
    }

    if (led_state.caps_lock) {
        writePinLow(GP27);  // ON (active-low)
    } else {
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
     KC_ESC,    TASK,    COPY,    PAST,    VDLT,    VDRT,    VDDN,    VDRT,           KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,       KC_LEFT,   KC_UP, KC_RGHT,             SNIP,
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,            KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  KC_F16,                KC_DOWN,                      EXPL,
     KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSLS, KC_BSPC, KC_BSPC,                KC_COMM,    KC_7,    KC_8,    KC_9,  KC_TAB,
     KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,  KC_ENT,                          KC_DOT,    KC_4,    KC_5,    KC_6,
   TG(_NUM), KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_ENT,  KC_ENT,                         KC_PMNS,    KC_1,    KC_2,    KC_3, KC_PENT,
    KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, KC_RSFT, KC_RSFT,                                     KC_0,             DZRO,    TZRO,
    KC_LCTL, MO(_FN), KC_LALT,                             KC_SPC,                                     KC_RALT, KC_LGUI, KC_RCTL),
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PPLS, KC_PAST, _______, _______,                         _______, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PEQL, KC_PSLS, _______,                                  _______,          _______, _______,
    _______, _______, _______,                            _______,                                     _______, _______, _______),
    
    [_FN] = LAYOUT(
    QK_BOOT, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,          VDLT,    VDUP,    VDRT,          _______,
    _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______, _______,                   VDDN,                   _______,
     KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_DEL,  KC_DEL,                _______, _______, _______, _______, _______,
       SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______, _______,                         _______, _______, _______, _______,
    _______, KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,                         _______, _______, _______, _______, _______,
    _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______, _______,                                  _______,          _______, _______,
