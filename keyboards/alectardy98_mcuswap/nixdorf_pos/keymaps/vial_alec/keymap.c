...
bool led_update_user(led_t led_state) {
    if (IS_LAYER_ON(_FN) || led_state.scroll_lock) {
        writePinHigh(GP4);  // ON (active-low)
    } else {
        writePinLow(GP4); // OFF
    }
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_INS,  KC_DEL,     KC_LCTL, KC_LALT, KC_LGUI,      KC_ESC, _______, \
      KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC,           KC_DEL, _______, KC_HOME,     KC_PSLS, KC_PAST, KC_PMNS,        EXPL,    SNIP, \
      KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,  KC_ENT,          KC_PGUP, KC_PGDN,  KC_END,        KC_7,    KC_8,    KC_9,        COPY,    PAST, \
     MO(_FN),    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,                            KC_MPRV, KC_MPLY, KC_MNXT,        KC_4,    KC_5,    KC_6,        VDLT,    VDRT, \
     KC_LSFT, _______,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,                   KC_VOLD,   KC_UP, KC_VOLU,        KC_1,    KC_2,    KC_3,     KC_PENT, \
                                                                    KC_SPC,                                                                KC_LEFT, KC_DOWN, KC_RGHT,        KC_0,    DZRO, KC_PDOT),
    [_FN] = LAYOUT(
     QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______, _______, _______,     QK_BOOT, _______, \
      KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,          _______, _______, _______,     _______, _______, _______,     _______, _______, \
        SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, KC_BSLS, KC_BSLS, _______,          _______, _______, _______,     _______,    VDUP, _______,     _______, _______, \
     _______, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU,                            _______, _______, _______,        VDLT,    QUIT,    VDRT,     _______, _______, \
     KC_CAPS, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, KC_CAPS,                   _______,    VDUP, _______,     _______,    VDDN, _______,     _______, \
                                                                    _______,                                                                   VDLT,    VDDN,    VDRT,     _______, _______, _______),
};
