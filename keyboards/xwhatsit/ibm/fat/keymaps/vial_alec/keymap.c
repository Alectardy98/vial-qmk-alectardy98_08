...
bool led_update_user(led_t led_state) {
    // FN LED (C6): ON if FN layer or Scroll Lock
    ...
    // NUM LED (C7): ON if NUM layer or Num Lock
    ...
    // CAPS LED (F0): ON if Caps Lock is active
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
         KC_ESC,    TASK,    KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, _______, KC_BSPC,        TG(_NUM), KC_PSLS, KC_PAST, KC_PMNS,
        DM_PLY1, DM_PLY2,    KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,          KC_BSLS,          KC_INS, KC_HOME, KC_PGUP, KC_PPLS,
           SNIP,    EXPL,   KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,           KC_ENT,          KC_DEL,  KC_END, KC_PGDN,  KC_SPC,
    ...
    [_FN] = LAYOUT(
        QK_BOOT, _______,    KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_DEL,        _______, _______, _______, _______,
        DM_REC1, DM_REC2,      SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______,          _______,        _______, _______, _______, _______,
        ...
        _______, _______,   KC_LGUI,          _______,                            HF_TOGG,                                              _______,          _______,           VDLT,    VDDN,    VDRT, _______
    ),
