...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
        ...
        DM_PLY1, DM_PLY2,     KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,    KC_7,    KC_8,    KC_9,  KC_PPLS,
           ...
           VDLT,    VDRT,    KC_LCTL, MO(_FN), KC_LALT,                   KC_BSPC, _______,  KC_SPC,                   KC_RALT, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT,    KC_0, KC_PDOT,  KC_PENT
    ),
    [_NUM] = LAYOUT(
    ...
    [_FN] = LAYOUT(
        QK_BOOT, _______,     KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL, _______, _______, _______, _______,
        ...
        _______, _______,    KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,    VDLT,    QUIT,    VDRT, _______,
