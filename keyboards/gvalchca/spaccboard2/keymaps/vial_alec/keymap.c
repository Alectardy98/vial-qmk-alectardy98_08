...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KC_LCTL, MO(_FN), KC_LALT,                             KC_SPC,                                     KC_RALT, KC_LGUI, KC_RCTL),
   ...
   KC_ESC,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  _______,  KC_DEL,
     SNIP, _______,    VDUP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  KC_LCTL,    VDLT,    VDDN,    VDRT, _______, _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,
  ...
  QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_DEL,
     SNIP, _______, _______, _______, _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS,   KC_UP,  KC_INS, _______,
