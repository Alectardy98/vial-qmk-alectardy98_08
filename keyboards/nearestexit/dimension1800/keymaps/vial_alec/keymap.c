...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
                                                                                                                                                 KC_ESC,    TASK,    COPY,    PAST,
     KC_ESC,    SNIP,    EXPL,    COPY,    PAST,    VDLT,    VDRT,    VDUP,    VDDN, KC_PSCR, KC_SCRL, KC_PAUS,  KC_INS, KC_HOME, KC_PGUP,        KC_F1,   KC_F2,   KC_F3,   KC_F4,
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11, KC_F12,   KC_DEL,  KC_END, KC_PGDN,        KC_F5,   KC_F6,   KC_F7,   KC_F8,

     KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC,              TG(_NUM), KC_PSLS, KC_PAST, KC_PEQL,
    ...
    MO(_FN), KC_LALT,                                      KC_SPC,                            KC_RALT, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT,         KC_0, KC_PDOT
    ),
    ...
    _______,          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______,       KC_END, KC_DOWN, KC_PGDN, _______,
    _______, _______,                                     _______,                            _______, _______,          _______, _______, _______,       KC_INS, KC_DEL
    ),
