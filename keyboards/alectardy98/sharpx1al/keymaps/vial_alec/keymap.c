...
bool led_update_kb(led_t led_state) {
    ...
    writePin(GP12, led_state.compose);
    writePin(GP27, led_state.kana);
    return true;
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_DEL,     _______, _______, _______, _______, \
       SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______,  KC_INS, _______,     _______, _______, _______, _______, \
