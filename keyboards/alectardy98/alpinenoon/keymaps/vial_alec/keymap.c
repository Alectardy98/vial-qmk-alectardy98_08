...
[_FN] = LAYOUT(
  ...
  _______, MU_NEXT, _______, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,  KC_INS, \
  CK_DOWN,   CK_UP, _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,    VDUP, _______, \
  CK_TOGG, MU_TOGG, KC_LGUI, _______, _______,                            _______,                   _______, _______,             VDLT,    VDDN,   VDRT),
