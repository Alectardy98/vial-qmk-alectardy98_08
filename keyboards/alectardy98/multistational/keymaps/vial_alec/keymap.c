...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN] = LAYOUT(
                          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
                          _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
    _______, _______,     QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL, _______,    _______, _______, _______,    _______, _______, _______, CK_DOWN, \
    DM_REC1, DM_REC2,        SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______,             _______, _______, _______,    _______,    VDUP, _______,   CK_UP, \
    ...
    _______, _______,     _______,         KC_LGUI,              BEEP, CK_TOGG, MU_TOGG,          MU_NEXT,          _______,                                        _______,    VDDN, _______,    _______, _______, _______, _______ ),
};
