...
[_BASE] = LAYOUT(
     ...
     KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC,  KC_ENT,      KC_DEL,  KC_END, KC_PGDN,           KC_7,    KC_8,    KC_9, KC_PPLS,
    KC_LCTL, KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, KC_BSLS,                KC_UP,                    KC_4,    KC_5,    KC_6, _______,
    KC_LSFT, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,              KC_LEFT, KC_DOWN, KC_RGHT,           KC_1,    KC_2,    KC_3, KC_PENT,
                      MO(_FN),                                      KC_SPC,                                                                                                KC_0,          KC_PDOT),
...
[_FN] = LAYOUT(
    ...
    _______, KC_LALT, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______,                 VDUP,                    VDLT,    QUIT,    VDRT, _______,
    _______, KC_LGUI, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,                 VDLT,    VDDN,    VDRT,        _______,    VDDN, _______, _______,
