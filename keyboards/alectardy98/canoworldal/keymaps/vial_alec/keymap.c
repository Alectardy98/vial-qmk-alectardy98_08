...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
     KC_ESC,    TASK,            KC_F1,   KC_F2,   KC_F3,   KC_F4,            KC_F5,   KC_F6,   KC_F7,   KC_F8,             EXPL,    SNIP,                COPY,             PAST,         KC_MPRV, KC_MPLY, KC_MNXT,          \
     KC_ESC,  KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSPC, KC_BSPC,     KC_INS,   KC_UP, KC_PGUP,            KC_7,    KC_8,    KC_9, KC_PMNS, \
    KC_LALT,  KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,             KC_LEFT, KC_DOWN, KC_RGHT,            KC_4,    KC_5,    KC_6, KC_COMM, \
    KC_LCTL, KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_ENT,  KC_ENT,              KC_DEL, KC_DOWN, KC_PGDN,            KC_1,    KC_2,    KC_3, KC_PENT, \
    KC_LCTL, KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_GRV, KC_RSFT,                         VDLT,             VDRT,                     KC_0, KC_PDOT,          \
                                        MO(_FN),  KC_SPC,  KC_SPC, KC_RALT, KC_LGUI,                                                                      VDUP,            VDDN),                                             \
    ...
    _______, _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_DEL,    _______,    VDUP, _______,         _______,    VDUP, _______, _______, \
    _______,    SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______,                VDLT,    VDDN,    VDRT,            VDLT,    QUIT,    VDRT, _______, \
    _______, KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,             _______,    VDDN, _______,         _______,    VDDN, _______, _______, \
    _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,                      _______,          _______,                  _______, _______,          \
