...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                        MS_UP,          \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                      MS_LEFT, MS_RGHT, \
        _______, _______, _______, _______,          _______,          _______,          _______,          _______, _______,                      MS_DOWN,          \
                                                              MS_BTN1, MS_BTN2                                                                                      \
        ),
    [_FN] = LAYOUT(
