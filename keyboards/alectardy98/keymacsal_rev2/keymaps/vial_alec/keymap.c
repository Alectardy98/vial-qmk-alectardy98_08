...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
           CUTT,             COPY,             PAST,          _______,          _______,          _______,          _______,          KC_VOLD,          KC_VOLU,     QUIT, \
    ...
    [_FN] = LAYOUT(
        ...
        QK_BOOT, _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_INS, _______, _______, \
        _______,    SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______, DM_REC1, _______,          \
