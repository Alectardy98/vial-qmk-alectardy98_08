...
[_BASE] = LAYOUT(
      TASK,  KC_ESC, _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,            KC_MPRV, KC_MNXT, KC_MPLY, \
    KC_GRV, _______,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, _______, KC_BSPC,      KC_7,    KC_8,    KC_9, \
    KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,                        KC_4,    KC_5,    KC_6, \
   KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,  KC_ENT,                        KC_1,    KC_2,    KC_3, \
   KC_LSFT, _______,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, _______,                        KC_0,   KC_UP, _______,  KC_DOT, \
   KC_LCTL, MO(_FN), KC_LALT, _______, _______,           KC_SPC,          _______, _______, KC_RALT, KC_LGUI, KC_RCTL,                     KC_LEFT, _______, KC_DOWN, _______, KC_RGHT, _______),
...
[_FN] = LAYOUT(
   QK_BOOT, QK_BOOT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            _______, _______, _______, \
   MU_TOGG, _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_DEL,    KC_INS, KC_HOME, KC_PGUP, \
      SNIP,    THIS,     OOF,    PIKA,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT,    KING, _______, _______, _______,                      KC_DEL,  KC_END, KC_PGDN, \
   KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,                     _______, _______, _______, \
   _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,                     _______,    VDUP, _______, _______, \
   KC_LGUI, _______, _______, _______, _______,          CK_TOGG,          _______, _______, _______, _______, _______,                        VDLT, _______,    VDDN, _______,    VDRT, _______),
};
