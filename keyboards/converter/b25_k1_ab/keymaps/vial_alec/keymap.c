...
bool led_update_kb(led_t led_state) {
    ...
    if (layer_state_is(_FN)) {
        ...
        set_itw_led(LED_F1, 0);
        set_itw_led(LED_F2, 0);
        set_itw_led(LED_F3, 0);
        set_itw_led(LED_F8, 0);
        set_itw_led(LED_F9, 0);
        set_itw_led(LED_F10, 0);
    }

    return true; // Let other LED update functions run too
}
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT(
		   QUIT, TG(_NUM),                                                                                                                                     KC_MPRV,   KC_UP, KC_MNXT,
		 KC_ESC,     TASK,      KC_F1,  KC_F2,   KC_F3,                 KC_F4, KC_F5,  KC_F6, KC_F7,                               KC_F8,   KC_F9,  KC_F10,    KC_LEFT, KC_DOWN, KC_RGHT,

        DM_PLY1,  DM_PLY2,     KC_GRV,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_MINS,  KC_EQL, KC_BSPC,       KC_7,    KC_8,    KC_9, KC_PPLS,
           SNIP,     EXPL,     KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_BSLS, KC_LBRC, KC_RBRC,       KC_4,    KC_5,    KC_6, KC_PMNS,
		   COPY,     PAST,    KC_CAPS,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_QUOT,  KC_ENT,                KC_1,    KC_2,    KC_3, KC_PENT,
		   VDLT,     VDRT,    KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,                         KC_0,          KC_PDOT,
                                               MO(_FN),                           KC_SPACE,                            KC_RALT
	),
    [_NUM] = LAYOUT(
        ...
        _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,     KC_LEFT, _______, KC_RGHT, _______,
        ...
        _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                        KC_INS,           KC_DEL,
                                               _______,                            _______,                            _______
    ),
    [_FN] = LAYOUT(
        QK_BOOT, _______,                                                                                                                                      KC_VOLD,    VDUP, KC_VOLU,
        QK_BOOT, _______,    _______, _______, _______,    _______, _______, _______, _______,                                  _______, _______, _______,        VDLT,    VDDN,    VDRT,

        DM_REC1, DM_REC2,    QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12,  KC_DEL,     _______,    VDUP, _______, _______,
        _______, _______,       SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______, _______,        VDLT,    QUIT,    VDRT, _______,
        _______, _______,    KC_RCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______, _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______,              _______,    VDDN, _______, _______,
        _______, _______,    KC_RGUI, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______,                       _______,          _______,
