...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT(
     KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL, KC_BSLS,  KC_DEL,    SNIP,      KC_INS, KC_HOME, KC_PGUP,     KC_PCMM, KC_PSLS, KC_PAST, KC_PEQL,  \
    ...
    KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT,  KC_GRV,  KC_ENT,             PAST,     KC_MPRV, KC_MPLY, KC_MNXT,        KC_4,    KC_5,    KC_6, KC_PMNS,  \
    ...
    KC_LCTL, MO(_FN), KC_LALT,                                      KC_SPC,                                     KC_RALT, KC_LGUI, KC_RCTL,              KC_LEFT, KC_DOWN, KC_RGHT,        KC_0,    DZRO, KC_PDOT, KC_PENT   \
        ),
    
    [_FN] = LAYOUT(
    QK_BOOT,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______, _______, _______,     _______, _______, _______,     _______, _______, _______, _______,  \
       SNIP,    THIS,     OOF,    PIKA,    SCAT,    FCAT,    HART,    DROL,    MONY,    FHAT,    SPIT, _______, _______,  KC_DEL,          _______,     _______, _______, _______,     _______,    VDUP, _______, _______,  \
