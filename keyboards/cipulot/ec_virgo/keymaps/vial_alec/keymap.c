...
[_BASE] = LAYOUT(
         ...
         KC_TAB,    KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,                  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P, KC_LBRC, KC_RBRC, KC_BSLS,  _______,   KC_DEL,   KC_END, KC_PGDN,
        KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                  KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, _______,  KC_ENT,
        KC_LSFT, _______,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,         KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT, _______,                       KC_UP,
        KC_LCTL,          MO(_FN), KC_LALT,           KC_SPC,                KC_SPC,          KC_RALT, KC_RGUI,          KC_RCTL,                              KC_LEFT, KC_DOWN, KC_RIGHT),
...
[_FN] = LAYOUT(
        ...
        _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,        KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______,  KC_DEL,            _______, _______, _______,
           SNIP,    THIS,     OOF,    PIKA,    FCAT,    HART,                  DROL,    MONY,    FHAT,    SPIT,    KING, _______, _______, _______, _______,   _______, _______, _______,
        KC_LCTL, C(KC_A), C(KC_S), C(KC_D), C(KC_F), _______,               _______, _______, _______, _______, KC_VOLD, KC_VOLU, _______, _______,
        _______, _______, C(KC_Z), C(KC_X), C(KC_C), C(KC_V), _______,      _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, _______, _______,                        VDUP,
